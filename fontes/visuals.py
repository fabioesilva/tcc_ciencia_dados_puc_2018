...
def distribution(data, transformed = False, cols=['QT_DIARIAS', 'VAL_UTI', 'VAL_TOT']):
    """
...
def evaluate(results, accuracy, f1):
    ...
    # Aesthetics
    pl.suptitle("Métricas de Performance para os 3 Modelos de Aprendizado Supervisionado", fontsize = 16, y = 1.10)
    pl.tight_layout()
    pl.show()
